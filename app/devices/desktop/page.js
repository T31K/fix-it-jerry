...
export default function page() {
  ...
  const smartphoneItem = repairItems.find(
          ...
          <div className="container relative z-2">
            <div className="row justify-content-center">
              <div className="col-lg-6 text-center">
                ...
                <h1 className="md:whitespace-nowrap">Smartphone Repair</h1>
              </div>
            </div>
          </div>
              ...
              <section className="col-lg-9 !py-0">
                <div className="row">
                  <div className="col-sm-12 col-md-12 mb-4">
                    ...
                    <p>{smartphoneItem?.description}</p>
                  </div>
                </div>

                {smartphoneItem?.services.map((service, serviceIndex) => (
...
export async function generateMetadata() {
  ...
  return {
    ...
    description: `${smartphoneItem?.description}`,
    openGraph: {
      title: `Smartphone Repair | Fix It Jerry | #1 Phone, Devices, Gadget Repair in KL`,
      description: `${smartphoneItem?.description}`,
