...
export default function page() {
  // Get the apple watch item from repairItems
  const appleWatchItem = repairItems.find(
    (item) => item.title === "Apple Watch"
  );
          ...
          <div className="container relative z-2">
            <div className="row justify-content-center">
              <div className="col-lg-6 text-center">
                ...
                <h1 className="md:whitespace-nowrap">Apple Watch Repair</h1>
              </div>
            </div>
          </div>
              ...
              <section className="col-lg-9 !py-0">
                <div className="row">
                  <div className="col-sm-12 col-md-12 mb-4">
                    <h2 className="!text-4xl">Smartphone Services</h2>
                    <p>{appleWatchItem?.description}</p>
                  </div>
                </div>

                {appleWatchItem?.services.map((service, serviceIndex) => (
...
export async function generateMetadata() {
  const appleWatchItem = repairItems.find(
    (item) => item.title === "Smartphone"
  );

  return {
    title: `Smartphone Repair | Fix It Jerry | #1 Phone, Devices, Gadget Repair in KL`,
    description: `${appleWatchItem?.description}`,
    openGraph: {
      title: `Smartphone Repair | Fix It Jerry | #1 Phone, Devices, Gadget Repair in KL`,
      description: `${appleWatchItem?.description}`,
    ...
    twitter: {
      ...
      title: `Smartphone Repair | #1 Phone, Devices, Gadget Repair in KL`,
      description: `${appleWatchItem?.description}`,
      images: ["https://fixitjerry.com/og.png"],
    },
  };
