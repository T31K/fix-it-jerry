...
export default function page() {
  // Get the laptop item from repairItems
  const laptopItem = repairItems.find((item) => item.title === "Laptop");
        ...
        <section id="subheader" className="relative jarallax text-light">
          ...
          <div className="container relative z-2">
            <div className="row justify-content-center">
              <div className="col-lg-6 text-center">
                ...
                <h1 className="md:whitespace-nowrap">Laptop Repair</h1>
              </div>
            </div>
          </div>
          <div className="crumb-wrapper">
            <ul className="crumb">
              ...
              <li>
                <a href="/services/laptop">Laptop</a>
              </li>
            </ul>
          </div>
              ...
              <section className="col-lg-9 !py-0">
                <div className="row">
                  <div className="col-sm-12 col-md-12 mb-4">
                    <h2 className="!text-4xl">Laptop Services</h2>
                    <p>{laptopItem?.description}</p>
                  </div>
                </div>

                {laptopItem?.services.map((service, serviceIndex) => (
...
export async function generateMetadata() {
  ...
  return {
    title: `Laptop Repair | Fix It Jerry | #1 Laptop, Devices, Gadget Repair in KL`,
    description: `${laptopItem?.description}`,
    openGraph: {
      title: `Laptop Repair | Fix It Jerry | #1 Laptop, Devices, Gadget Repair in KL`,
      description: `${laptopItem?.description}`,
      url: `https://fixitjerry.com/services/devices/laptop`,
    ...
    twitter: {
      ...
      title: `Laptop Repair | #1 Laptop, Devices, Gadget Repair in KL`,
      description: `${laptopItem?.description}`,
      images: ["https://fixitjerry.com/og.png"],
    },
  };
