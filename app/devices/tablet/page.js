        ...
        <section id="subheader" className="relative jarallax text-light">
          ...
          <div className="container relative z-2">
            <div className="row justify-content-center">
              <div className="col-lg-6 text-center">
                ...
                <h1 className="md:whitespace-nowrap">Tablet Repair</h1>
              </div>
            </div>
          </div>
          <div className="crumb-wrapper">
            <ul className="crumb">
              ...
              <li>
                <a href="/services/tablet">Tablet</a>
              </li>
            </ul>
          </div>
              ...
              <section className="col-lg-9 !py-0">
                <div className="row">
                  <div className="col-sm-12 col-md-12 mb-4">
                    <h2 className="!text-4xl">Tablet Services</h2>
                    <p>{tabletItem?.description}</p>
                  </div>
                </div>

                {/* Loop through all tablet services */}
                {tabletItem?.services.map((service, serviceIndex) => (
...
export async function generateMetadata() {
  ...
  return {
    title: `Tablet Repair | Fix It Jerry | #1 Tablet, Devices, Gadget Repair in KL`,
    description: `${tabletItem?.description}`,
    openGraph: {
      title: `Tablet Repair | Fix It Jerry | #1 Tablet, Devices, Gadget Repair in KL`,
      description: `${tabletItem?.description}`,
      url: `https://fixitjerry.com/services/devices/tablet`,
    ...
    twitter: {
      ...
      title: `Tablet Repair | #1 Phone, Devices, Gadget Repair in KL`,
      description: `${tabletItem?.description}`,
      images: ["https://fixitjerry.com/og.png"],
    },
  };
