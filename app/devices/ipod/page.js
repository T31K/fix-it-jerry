        ...
        <section id="subheader" className="relative jarallax text-light">
          ...
          <div className="container relative z-2">
            <div className="row justify-content-center">
              <div className="col-lg-6 text-center">
                ...
                <h1 className="md:whitespace-nowrap">iPod Repair</h1>
              </div>
            </div>
          </div>
          <div className="crumb-wrapper">
            <ul className="crumb">
              ...
              <li>
                <a href="/services/smartphone">iPod</a>
              </li>
            </ul>
          </div>
              ...
              <section className="col-lg-9 !py-0">
                <div className="row">
                  <div className="col-sm-12 col-md-12 mb-4">
                    <h2 className="!text-4xl">iPod Services</h2>
                    <p>{ipodItem?.description}</p>
                  </div>
                </div>

                {ipodItem?.services.map((service, serviceIndex) => (
...
export async function generateMetadata() {
  ...
  return {
    title: `iPod Repair | Fix It Jerry | #1 Phone, Devices, Gadget Repair in KL`,
    description: `${ipodItem?.description}`,
    openGraph: {
      title: `iPod Repair | Fix It Jerry | #1 Phone, Devices, Gadget Repair in KL`,
      description: `${ipodItem?.description}`,
    ...
    twitter: {
      ...
      title: `iPod Repair | #1 Phone, Devices, Gadget Repair in KL`,
      description: `${ipodItem?.description}`,
      images: ["https://fixitjerry.com/og.png"],
    },
  };
