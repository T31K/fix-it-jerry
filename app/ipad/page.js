...
export const metadata = {
  title: "iPad Repair in Kuala Lumpur | Fix It Jerry",
  description:
...
export default function IpadHubPage() {
  const modelsByYear = ipadModels.slice().reverse();
          ...
          <div className="container">
            <div className="row justify-content-center mb-8">
              <div className="col-lg-8 text-center">
                ...
                <h2 className="mb-3">iPad Repairs We Handle</h2>
            ...
            <div className="row justify-content-center mb-6">
              <div className="col-lg-10 text-center">
                ...
                <h2 className="mb-6">All iPad Models We Repair</h2>
              </div>
            </div>
                  ...
                  >
                    <div className="bg-white border rounded-lg p-4 text-center hover:shadow-md transition-shadow h-full">
                      ...
                      <div className="text-muted small mt-1">
                        {ipadServices.length} services available
                      </div>
                    </div>
                  </Link>
                </div>
