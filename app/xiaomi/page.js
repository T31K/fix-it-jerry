...
export const metadata = {
  title: "Xiaomi Repair in Kuala Lumpur | Fix It Jerry",
  description:
    "Xiaomi repair in KL. Screen, battery, charging port, water damage & back glass. Redmi, Poco and Xiaomi flagships. Walk in or book online.",
  openGraph: {
    title: "Xiaomi Repair in Kuala Lumpur | Fix It Jerry",
    description:
      "Xiaomi repair in KL. Screen, battery, charging port, water damage & back glass. Redmi, Poco and Xiaomi flagships. Walk in or book online.",
  },
  alternates: { canonical: '/xiaomi' },
};

export default function XiaomiHubPage() {
  const modelsByYear = xiaomiModels.slice().reverse();
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <h1 className="!text-[28px] md:!text-[48px]">
                  Xiaomi Repair in Kuala Lumpur
                </h1>
                <p className="text-gray-200 max-w-2xl mx-auto !text-[16px] md:!text-[20px] text-center mt-3">
                  Redmi, Poco and Xiaomi flagships. Snapdragon and MediaTek chips. Fast turnaround.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row justify-content-center mb-8">
              <div className="col-lg-8 text-center">
                ...
                <h2 className="mb-3">Xiaomi Repairs We Handle</h2>
            ...
            <div className="row justify-content-center mb-6">
              <div className="col-lg-10 text-center">
                ...
                <h2 className="mb-6">All Xiaomi Models We Repair</h2>
              </div>
            </div>
                  ...
                  >
                    <div className="bg-white border rounded-lg p-4 text-center hover:shadow-md transition-shadow h-full">
                      ...
                      <div className="text-muted small mt-1">
                        {xiaomiServices.length} services available
                      </div>
                    </div>
                  </Link>
                </div>
