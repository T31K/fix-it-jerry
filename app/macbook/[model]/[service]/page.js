...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: service.getTitle(model),
      description: service.getMetaDescription(model),
      images: [`https://www.fixitjerry.com/og_images/macbook-${params.model}-${params.service}.png`],
    },
    alternates: { canonical: `/macbook/${params.model}/${params.service}` },
  };
}
  ...
  return (
    <div id="wrapper">
            ...
            <div className="row g-4 g-lg-5">
              <div className="col-lg-8">
                <div className="bg-white rounded-xl shadow-sm border p-4 md:p-8">
                    ...
                    <DeviceGallery brand="macbook" slug={model.slug} name={model.name} />
      ...
      <ServiceJsonLd
        model={model}
        service={service}
        url={`https://www.fixitjerry.com/macbook/${model.slug}/${service.slug}`}
      />
      <Footer />
