// Country calling codes for the booking form phone field.
// `pinned` entries are shown at the top of the dropdown (primary markets).
// `min`/`max` are the expected national number length (digits, after any
// leading trunk "0" is stripped). Countries without explicit lengths fall
// back to DEFAULT_PHONE_LENGTH.

export const DEFAULT_PHONE_LENGTH = { min: 6, max: 12 };
...
export function phoneLengthFor(country) {
