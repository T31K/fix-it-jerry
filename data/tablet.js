const tabletItems = {
    ...
    services: [
        ...
        sections: [
          {
            ...
            content:
              "Water can enter the tablet and damage internal components. Symptoms include screen flickering, overheating, no sound, charging issues, and unresponsive touch.",
          },
          {
      ...
      },
      {
        ...
        service: "Power IC",
        hash: "power-ic",
        title: "Tablet Power IC Repair | Fix It Jerry",
        ...
        sections: [
          {
            ...
            content:
              "The Power IC (integrated circuit) controls power distribution in your tablet. A faulty IC can cause boot loops, overheating, and shutdowns.",
          },
          {
          ...
          },
          {
            ...
            content: [
              ...
              "Stop charging if the tablet heats excessively.",
      ...
      },
      {
        ...
        service: "Baseband IC",
        hash: "baseband-ic",
        title: "Tablet Baseband IC Repair | Fix It Jerry",
      ...
      },
      {
        ...
        service: "Audio IC",
        hash: "audio-ic",
        title: "Tablet Audio IC Repair | Fix It Jerry",
        image: "/images/devices/smartphone/audio_ic.webp",
        meta_description:
          "No sound during calls or mic not working? We specialize in Audio IC repair for tablets with sound and voice issues.",
        sections: [
          {
        ...
        sections: [
          {
            ...
            content:
              "The Charging IC controls voltage flow during charging. It protects your tablet’s battery and motherboard.",
          },
          {
          ...
          },
          {
            ...
            content: [
              ...
              "Continuing to charge when tablet overheats.",
      ...
      },
      {
        ...
        service: "Touch IC",
        hash: "touch-ic",
        title: "Tablet Touch IC Repair | Fix It Jerry",
  ...
  sections: [
    {
      ...
      content: [
        ...
        "Black screen even when tablet is on.",
    ...
    },
    {
      ...
      },
      {
        ...
        service: "Housing",
        hash: "housing",
        title: "Tablet Housing Replacement | Fix It Jerry",
        image: "/images/devices/smartphone/housing.webp",
        meta_description:
          "Phone looking beat up? Fix It Jerry offers full tablet housing replacements for a fresh look and restored durability.",
        sections: [
          {
            heading: "Signs You Need a Housing Replacement",
            content: [
              "Dented or cracked tablet frame.",
      ...
      },
      {
        ...
        service: "Mic & Speaker",
        hash: "mic-speaker",
        title: "Tablet Mic & Speaker Replacement | Fix It Jerry",
      ...
      },
      {
        ...
        meta_description:
          "Charging problems or no WiFi? We replace your tablet’s charging port and antenna modules with precision.",
        sections: [
          {
      ...
      },
      {
        ...
        hash: "buttons",
        title: "Tablet Button Replacement | Fix It Jerry",
        image: "/images/devices/smartphone/home_button.webp",
        meta_description:
          "Power button not working? Volume buttons stuck? We replace tablet home, power, and volume buttons efficiently.",
        sections: [
          {
      ...
      title: "Tablet Storage Upgrade | Fix It Jerry",
      image: "/images/devices/smartphone/storage_upgrade.webp",
      meta_description:
        "Running out of space? Fix It Jerry upgrades your tablet’s internal storage so you can store more and perform faster.",
      sections: [
        {
  ...
  title: "Tablet OS, App & Software Installation | Fix It Jerry",
  image: "/images/devices/smartphone/installation_reformat.webp",
  meta_description:
    "Slow tablet? Buggy apps? Fix It Jerry formats and installs OS, apps, and software to give your tablet a fresh start.",
  sections: [
    {
    ...
    },
    {
      ...
      },
      {
        ...
        title: "Tablet General Servicing | Fix It Jerry",
        image: "/images/devices/smartphone/general_servicing.webp",
        meta_description:
          "Dusty ports? Sluggish performance? Fix It Jerry offers general servicing for your tablet to keep it running smooth.",
        sections: [
          {
        ...
        sections: [
          {
            ...
            content: [
              ...
              "Bought a second-hand tablet that’s still locked.",
      ...
      },
      {
        ...
        meta_description:
          "Accidentally deleted files or can't access tablet data? Fix It Jerry provides full data backup and recovery services.",
        sections: [
          {
